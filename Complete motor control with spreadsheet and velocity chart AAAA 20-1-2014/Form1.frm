...
' Printing Final Velocity in PWM
                    test = (Mid(serdata, b, 2))
                    If test = "22" Then
                        For Y = 1 To 5
                            test1 = (Mid(serdata, b + 1 + Y, 1))
                            txtoutputvel.Text = txtoutputvel.Text + test1
                        Next Y
                        Form2.txtsheet.Text = txtoutputvel.Text
                        If Form2.txtsheet.Text <> vbKeySpace Then 'avoids empty spaces in between
                        Call Form2.transfer_vel
                        End If
'''''Transfering Velocity to form2 spreadsheet cells
                    End If
                End If
                If test = "3" Then
' Printing Direction
